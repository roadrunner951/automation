...
rights = nr.filter(F(rights__contains="ani")) #filtering devices using the contains (__) logic.
results = rights.run(task=banner_push) #pushing banner_push to specified devices that is mapped to the legends and courts keys in groups.yaml.  Also mapped on hosts.yaml file.
